...
class _StrukBottomSheetState extends State<StrukBottomSheet> {
  ...
  Future<void> _loadStore() async {
    try {
      ...
      // Gagal load profil toko → tampil struk tanpa header toko
    }
  }
 ...
 Future<void> _printReceipt() async {
  ...
  try {
    ...
    final success = await PrinterService.printReceipt(
      storeName: store?.storeName ?? 'Toko Sembako',
        ...
        child: Column(
          ...
          children: [
            ...
            if (_store != null) ...[
              ...
              if (_store!.logo != null) const SizedBox(height: 8),
            ...
            Text(
              'No. Struk: ${struk.nomorStruk}',
              style: const TextStyle(fontSize: 12, color: Color(0xFF6B7280)),
            ),
            Text(
              DateFormat('dd MMM yyyy, HH:mm').format(struk.waktu),
              style: const TextStyle(fontSize: 12, color: Color(0xFF6B7280)),
            ),
            const SizedBox(height: 20),
            const Divider(color: Color(0xFFE5E7EB)),
            ...
            _StrukRow(
              label: 'Metode',
              value: _labelMetode(struk.paymentType),
            ),

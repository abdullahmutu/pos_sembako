...
import 'package:mobile1/widgets/tambah_utang_form.dart';
...
class _TransaksiScreenState extends State<TransaksiScreen> {
  ...
  // Wrapper tipis — tidak ada try/catch/finally di sini
  // sehingga Dart analyzer tidak bingung soal return path
  ...
  Future<void> _prosesCheckout() async {
    try {
      ...
      // Snapshot keranjang sebelum checkout
      final itemsSnapshot = CartService.cart
      ...
      if (paymentType == 'debt') {
        ...
        // Tampung payload dari onSimpan — TambahUtangForm
        // akan pop sendiri setelah onSimpan selesai,
        // jadi JANGAN Navigator.pop di sini (hindari double pop)
        ...
        await showModalBottomSheet(
          ...
          builder: (_) => TambahUtangForm(
            ...
            onSimpan: (payload) async {
              ...
              // TambahUtangForm._simpan() sudah memanggil
              // Navigator.pop(context) sendiri setelahnya
            },
          ),
        );

        // Jika user batal (tutup sheet tanpa simpan)
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
              ...
              : _filteredList.isEmpty
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final stok =
                            produk['stock'] ?? produk['stok'] ?? 0;
                        final harga = double.parse(
                            produk['selling_price'].toString());
                        final kat = (produk['category']?['name'] ??
                                produk['kategori'] ??
                                '')
                            .toString()
                            .toUpperCase();
                        final menipis = stok < 10;
        ...
        // ── Cart Bottom Bar ──
        if (CartService.cart.isNotEmpty) _buildCartBar(),
      ],
    );
  }
  ...
  Widget _buildCartBar() {
    ...
    final hargaItem =
        double.parse(lastItem['selling_price'].toString());
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(
                    formatRupiah(CartService.totalHarga.toDouble()),
                    style: const TextStyle(
                      fontSize: 18,
...
class _KeranjangDetailSheet extends StatefulWidget {
  ...
  @override
  State<_KeranjangDetailSheet> createState() =>
      _KeranjangDetailSheetState();
}
          ...
          ConstrainedBox(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (_, i) {
                ...
                final harga =
                    double.parse(item['selling_price'].toString());
...
class _PaymentMethodSheetState extends State<_PaymentMethodSheet> {
  ...
  void _konfirmasi() {
    if (!_valid) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content: Text('Nominal kurang dari total tagihan!')),
      );
      return;
    }
    Navigator.pop(context, {
              ...
              child: TextField(
                ...
                onChanged: (val) => setState(() {
                  final angka = int.tryParse(val
                      ...
                      0;
                  _nominalDipilih =
                      _uangCepat.contains(angka) ? angka : 0;
                  _metodNonTunai = null;
                }),
                decoration: const InputDecoration(
                  prefixText: 'Rp  ',

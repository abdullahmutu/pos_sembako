    ...
    setState(() {
      ...
      if (query.trim().isEmpty) {
        ...
        _filteredCustomers = _customers
            .where(
                (c) => c.nama.toLowerCase().contains(query.toLowerCase()))
            .toList();
    ...
    try {
      ...
      if (_selectedCustomer != null) {
        ...
        final bodyCustomer = {
          ...
          if (_noHpCtrl.text.trim().isNotEmpty)
        ...
        final resData =
            res is Map && res['data'] != null ? res['data'] : res;
        customerId = resData['id'];

        final customerBaru = _CustomerOption(
          id: customerId,
          nama: namaInput,
          noHp: _noHpCtrl.text.trim().isNotEmpty
              ? _noHpCtrl.text.trim()
              : null,

...
public class FilePickerPlugin implements MethodChannel.MethodCallHandler, FlutterPlugin, ActivityAware {
    ...
    private void setup(
            ...
            final Object registrar, // kept generic; v1 registrar not used here
        ...
        if (activityBinding == null) {
            // No v2 activityBinding provided; nothing to register here for v1 because we removed v1 registration.
        } else {
